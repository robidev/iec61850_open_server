...
public class LogicalNode implements DataModelNode {
    ...
    public LogicalNode(Node lnNode, TypeDeclarations typeDeclarations, LogicalDevice parent) throws SclParserException {
        ...
        /* Parse inputs definitions */
        inputs = new LinkedList<Inputs>();

        List<Node> InputsNodes = ParserUtils.getChildNodesWithTag(lnNode, "Inputs");
        for (Node InputsNode : InputsNodes)
            inputs.add(new Inputs(InputsNode));
