...
def main(server_instance):
    ...
    if not mms_pos:
        print("could not find mms_pos data ref @IED1_XCBRGenericIO/XCBR1.Pos.stVal. quitting...")
        return 1
    ...
    print("new position value: ", str(lib61850.MmsValue_getBitStringAsInteger(pos)) )
