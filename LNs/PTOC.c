...
void Conversions_intToStringBuffer2(int intValue, int numberOfDigits, uint8_t *buffer)
{
  int digitBase = 1;
...
void Conversions_msTimeToGeneralizedTime2(uint64_t msTime, uint8_t *buffer)
{
